...
if ( ! function_exists( 'bright_posted_on' ) ) :
	...
	function bright_posted_on() { 
		...
		printf( __( '<p> <i class="icon-clock"></i> <a href="%1$s" title="%2$s" rel="bookmark"><time class="entry-date" datetime="%3$s" pubdate>%4$s</time></a><span class="byline"> <i class="icon-user"></i> <span class="author vcard"><a class="url fn n" href="%5$s" title="%6$s" rel="author">%7$s</a></span></span>', 'bright' ),
