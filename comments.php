 ...
 * handled by a callback to bright_comment() which is
...
?>
	...
	<?php if ( have_comments() ) : ?>
		...
		<nav id="comment-nav-above" class="navigation-comment" role="navigation">
			<h1 class="screen-reader-text"><?php _e( 'Comment navigation', 'bright' ); ?></h1>
	...
	?>
		<p class="no-comments"><?php _e( 'Comments are closed.', 'bright' ); ?></p>
	<?php endif; ?>
